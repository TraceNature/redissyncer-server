...
// checktaskCmd represents the checktask command
...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		execchecktask(viper.GetViper().GetString("server"), string(byteValue))
		os.Exit(0)
	},
}
...
func init() {
	...
	checktaskCmd.Flags().StringP("execfile", "e", "", "json file path to create a task")
}

func execchecktask(server string, createjson string) {

	url := server + "/api/v1/checktask"
