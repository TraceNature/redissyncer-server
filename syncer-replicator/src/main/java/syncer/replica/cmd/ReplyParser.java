...
public class ReplyParser {
    ...
    public Object parse(BulkReplyHandler handler, OffsetHandler offsetHandler) throws IOException, IncrementException {
        in.mark();
     ...
     */
    public Object parse(BulkReplyHandler handler) throws IOException, IncrementException {
        while (true) {
            int c = in.read();
            switch (c) {
                case DOLLAR:
                ...
                case '\n':
                    ...
                    break;
                default:
                    log.error("expect [$,:,*,+,-] but: {}",(char) c);
                    throw new IncrementException("expect [$,:,*,+,-] but: " + (char) c);
