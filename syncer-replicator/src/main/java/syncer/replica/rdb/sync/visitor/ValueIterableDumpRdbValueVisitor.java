...
import syncer.replica.rdb.DefaultRedisRdbValueVisitor;
...
import syncer.replica.util.objectutil.ByteBuilder;
import syncer.replica.util.objectutil.CRC64;
 ...
 * @Date 2020/12/22
 */
public class ValueIterableDumpRdbValueVisitor extends DefaultRedisRdbValueVisitor {
    private final int size;
    private final int version;


    public ValueIterableDumpRdbValueVisitor(Replication replication) {
        this(replication, -1);
    }

    public ValueIterableDumpRdbValueVisitor(Replication replication, int version) {
        this(replication, version, 8192);
    }


    public ValueIterableDumpRdbValueVisitor(Replication replication, int version, int size) {
        super(replication);
