 ...
 * @since 2.3.0
 */
public class ValueIterableRdbVisitor extends DefaultRedisRdbVisitor {

    public ValueIterableRdbVisitor(Replication replicator) {
        this(replicator, new ValueIterableRdbValueVisitor(replicator));
    }

    public ValueIterableRdbVisitor(Replication replicator, RedisRdbValueVisitor valueParser) {
