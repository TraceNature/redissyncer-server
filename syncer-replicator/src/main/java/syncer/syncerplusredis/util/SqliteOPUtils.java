...
import syncer.syncerplusredis.model.*;
...
//    static DUAbandonCommandMapper abandonCommandMapper=null;
//    static DUBigKeyMapper bigKeyMapper=null;
//    static DUDataCompensationMapper dataCompensationMapper=null;
//    static DURdbVersionMapper rdbVersionMapper=null;
//    static DUTaskMapper taskMapper=null;
//    static DUTaskOffsetMapper taskOffsetMapper=null;
//    static DUUserMapper userMapper=null;

    static {

//        abandonCommandMapper= new DUAbandonCommandMapper();
//        bigKeyMapper= new DUBigKeyMapper();
//        dataCompensationMapper=new DUDataCompensationMapper();
//        rdbVersionMapper= new DURdbVersionMapper();
//        taskMapper=new DUTaskMapper();
//        taskOffsetMapper=new DUTaskOffsetMapper();
//        userMapper=new DUUserMapper();
