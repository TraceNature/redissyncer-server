...
public class MultiTaskModel {
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        if (Double.compare(that.redisVersion, redisVersion) != 0) return false;
        if (lastKeyUpdateTime != that.lastKeyUpdateTime) return false;
        if (lastKeyCommitTime != that.lastKeyCommitTime) return false;
        ...
        if (!redisAddress.equals(that.redisAddress)) return false;
        if (!host.equals(that.host)) return false;
        if (!userName.equals(that.userName)) return false;
        if (!password.equals(that.password)) return false;
        if (!port.equals(that.port)) return false;
        if (!errorCount.equals(that.errorCount)) return false;
        if (!errorNums.equals(that.errorNums)) return false;
        if (!targetRedisType.equals(that.targetRedisType)) return false;
        if (!md5.equals(that.md5)) return false;
        if (!dataAnalysis.equals(that.dataAnalysis)) return false;
        if (!replId.equals(that.replId)) return false;
        if (!offset.equals(that.offset)) return false;
        if (!status.equals(that.status)) return false;
        if (!rdbVersion.equals(that.rdbVersion)) return false;
        if (!syncType.equals(that.syncType)) return false;
        if (!dbMapper.equals(that.dbMapper)) return false;
        if (!createTime.equals(that.createTime)) return false;
        if (!updateTime.equals(that.updateTime)) return false;
        if (!rdbKeyCount.equals(that.rdbKeyCount)) return false;
        if (!allKeyCount.equals(that.allKeyCount)) return false;
        if (!realKeyCount.equals(that.realKeyCount)) return false;
