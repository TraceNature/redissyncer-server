...
package syncer.syncerplusredis;
...
import static syncer.syncerplusredis.RedisSocketReplicator.SyncMode.*;
import static syncer.syncerplusredis.replicator.Status.*;
import static syncer.syncerplusredis.cmd.CommandParsers.toInt;
import static syncer.syncerplusredis.util.objectutil.Concurrents.terminateQuietly;
import static syncer.syncerplusredis.util.objectutil.Strings.format;
...
public class RedisSocketReplicator extends AbstractReplicator {
    ...
    protected void establishConnection() throws IOException {
        ...
        if (configuration.getAuthPassword() != null) {
            auth(configuration.getAuthUser(), configuration.getAuthPassword());
