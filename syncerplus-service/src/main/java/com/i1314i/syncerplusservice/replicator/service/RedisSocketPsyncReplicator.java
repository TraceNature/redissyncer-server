...
import static com.i1314i.syncerplusservice.replicator.service.RedisSocketPsyncReplicator.SyncMode.*;
...
public class RedisSocketPsyncReplicator extends AbstractReplicator {
    ...
    public RedisSocketPsyncReplicator(String host, int port, Configuration configuration) {
    ...
    public void open() throws IOException {
        ...
        try {
            new RedisSocketPsyncReplicator.RedisSocketReplicatorRetrier().retry(this);
        } finally {
            doClose();
    ...
    protected RedisSocketPsyncReplicator.SyncMode trySync(final String reply) throws IOException {
        logger.info(reply);
    ...
    private class RedisSocketReplicatorRetrier extends AbstractJDReplicatorRetrier {
        ...
        protected boolean isManualClosed() {
            return RedisSocketPsyncReplicator.this.isClosed();
        }
        ...
        protected boolean open() throws IOException {
            ...
            RedisSocketPsyncReplicator.SyncMode mode = trySync(reply);
