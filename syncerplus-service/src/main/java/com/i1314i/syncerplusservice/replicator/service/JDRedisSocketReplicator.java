...
public class JDRedisSocketReplicator extends AbstractReplicator implements Serializable {
    ...
    public void open() throws IOException {
        ...
        try {
            new JDRedisSocketReplicator.RedisSocketReplicatorRetrier().retry(this);
        } finally {
            doClose();
    ...
    protected JDRedisSocketReplicator.SyncMode trySync(final String reply) throws IOException {
        logger.info(reply);
...
//AbstractReplicatorRetrier
    private class RedisSocketReplicatorRetrier extends JDAbstractReplicatorRetrier {
        ...
        protected boolean open() throws IOException {
            ...
            JDRedisSocketReplicator.SyncMode mode = trySync(reply);
