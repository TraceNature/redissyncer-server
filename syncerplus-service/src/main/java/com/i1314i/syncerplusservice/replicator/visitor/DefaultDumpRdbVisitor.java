...
public class DefaultDumpRdbVisitor extends RdbVisitor {
    ...
    protected final RdbValueVisitor dumpValueVisitor;
    public DefaultDumpRdbVisitor(Replicator replicator) {
        this(replicator, new DefaultRdbValueVisitor(replicator),new DefaultRdbValueVisitor(replicator));
    }

    public DefaultDumpRdbVisitor(Replicator replicator, RdbValueVisitor valueVisitor, RdbValueVisitor dumpValueVisitor) {
        this.replicator = replicator;
        this.valueVisitor = valueVisitor;
        this.dumpValueVisitor=dumpValueVisitor;
    }
