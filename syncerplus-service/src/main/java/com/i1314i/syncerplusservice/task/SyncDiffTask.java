...
public class SyncDiffTask implements Runnable {
    ...
    public SyncDiffTask(String sourceUri, String targetUri) {
    ...
    public SyncDiffTask(String sourceUri, String targetUri, String threadName) {
        this.sourceUri = sourceUri;
        this.targetUri = targetUri;
    ...
    public SyncDiffTask(String sourceUri, String targetUri, int threadCount) {
        this.sourceUri = sourceUri;
        this.targetUri = targetUri;
    ...
    public SyncDiffTask(String sourceUri, String targetUri, int threadCount, String threadName) {
        this.sourceUri = sourceUri;
        this.targetUri = targetUri;
        this.threadCount = threadCount;
        if(StringUtils.isEmpty(threadName)){
