 ...
 * 扩展模块 该模块主要为二进制命令模块
 */
public class BinaryJedisClusterPlus implements BinaryJedisClusterCommands,
    ...
    protected JedisClusterConnectionHandlerPlus connectionHandler;

    public BinaryJedisClusterPlus(Set<HostAndPort> nodes, int timeout,Map<String,String>nodesMap) {
        this(nodes, timeout, DEFAULT_MAX_ATTEMPTS, new GenericObjectPoolConfig(),nodesMap);
    }

    public BinaryJedisClusterPlus(Set<HostAndPort> nodes,Map<String,String>nodesMap) {
        this(nodes, DEFAULT_TIMEOUT,nodesMap);
    }

    public BinaryJedisClusterPlus(Set<HostAndPort> jedisClusterNode, int timeout, int maxAttempts,
                                  final GenericObjectPoolConfig poolConfig,Map<String,String>nodesMap) {
        this.connectionHandler = new JedisSlotBasedConnectionHandlerPlus(jedisClusterNode, poolConfig,
                timeout,nodesMap);
        this.maxAttempts = maxAttempts;
        this.nodesMap=nodesMap;
    }

    public BinaryJedisClusterPlus(Set<HostAndPort> jedisClusterNode, int connectionTimeout,
                                  int soTimeout, int maxAttempts, final GenericObjectPoolConfig poolConfig,Map<String,String>nodesMap) {
        this.connectionHandler = new JedisSlotBasedConnectionHandlerPlus(jedisClusterNode, poolConfig,
                connectionTimeout, soTimeout,nodesMap);
        this.maxAttempts = maxAttempts;
        this.nodesMap=nodesMap;
    }

    public BinaryJedisClusterPlus(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, GenericObjectPoolConfig poolConfig,Map<String,String>nodesMap) {
        this.connectionHandler = new JedisSlotBasedConnectionHandlerPlus(jedisClusterNode, poolConfig,
                connectionTimeout, soTimeout, password,nodesMap);
        this.maxAttempts = maxAttempts;
        this.nodesMap=nodesMap;
    }

    public BinaryJedisClusterPlus(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, String clientName, GenericObjectPoolConfig poolConfig,Map<String,String>nodesMap) {
        this.connectionHandler = new JedisSlotBasedConnectionHandlerPlus(jedisClusterNode, poolConfig,
                connectionTimeout, soTimeout, password, clientName,nodesMap);
        this.maxAttempts = maxAttempts;
        this.nodesMap=nodesMap;
    }

    public BinaryJedisClusterPlus(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, String clientName, GenericObjectPoolConfig poolConfig,
                                  boolean ssl,Map<String,String>nodesMap) {
        this(jedisClusterNode, connectionTimeout, soTimeout, maxAttempts, password, clientName, poolConfig, ssl, null, null, null, null,nodesMap);
    }

    public BinaryJedisClusterPlus(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, String clientName, GenericObjectPoolConfig poolConfig,
                                  boolean ssl, SSLSocketFactory sslSocketFactory, SSLParameters sslParameters, HostnameVerifier hostnameVerifier, JedisClusterHostAndPortMap hostAndPortMap,Map<String,String>nodesMap) {
        this.connectionHandler = new JedisSlotBasedConnectionHandlerPlus(jedisClusterNode, poolConfig,
                connectionTimeout, soTimeout, password, clientName, ssl, sslSocketFactory, sslParameters, hostnameVerifier, hostAndPortMap,nodesMap);
        this.maxAttempts = maxAttempts;
        this.nodesMap=nodesMap;
    }
    ...
    public List<byte[]> hmget(final byte[] key, final byte[]... fields) {
        return new JedisClusterCommandPlus<List<byte[]>>(connectionHandler, maxAttempts,nodesMap) {
            @Override
    ...
    public Set<byte[]> hkeys(final byte[] key) {
        return new JedisClusterCommandPlus<Set<byte[]>>(connectionHandler, maxAttempts,nodesMap) {
            @Override
    ...
    public Collection<byte[]> hvals(final byte[] key) {
        return new JedisClusterCommandPlus<Collection<byte[]>>(connectionHandler, maxAttempts,nodesMap) {
            @Override
    ...
    public Map<byte[], byte[]> hgetAll(final byte[] key) {
        return new JedisClusterCommandPlus<Map<byte[], byte[]>>(connectionHandler, maxAttempts,nodesMap) {
            @Override
    ...
    public ScanResult<byte[]> scan(final byte[] cursor, final ScanParams params) {
        ...
        if (params == null || (matchPattern = paramsPlus.binaryMatch()) == null || matchPattern.length == 0) {
        ...
        return new JedisClusterCommandPlus<ScanResult<byte[]>>(connectionHandler, maxAttempts,nodesMap) {
            @Override
    ...
    public ScanResult<Map.Entry<byte[], byte[]>> hscan(final byte[] key, final byte[] cursor) {
        return new JedisClusterCommandPlus<ScanResult<Map.Entry<byte[], byte[]>>>(connectionHandler,maxAttempts,nodesMap) {
            @Override
    ...
    public ScanResult<Map.Entry<byte[], byte[]>> hscan(final byte[] key, final byte[] cursor,
        ...
        return new JedisClusterCommandPlus<ScanResult<Map.Entry<byte[], byte[]>>>(connectionHandler,
