...
import syncerservice.syncerplusredis.rdb.RdbVisitor;
...
public class DefaultRdbPlusVisitor extends RdbVisitor {
    ...
    public DefaultRdbPlusVisitor(Replicator replicator) {
        this(replicator, new DefaultRdbValuePlusVisitor(replicator));
    }

    public DefaultRdbPlusVisitor(Replicator replicator, RdbValueVisitor valueVisitor) {
