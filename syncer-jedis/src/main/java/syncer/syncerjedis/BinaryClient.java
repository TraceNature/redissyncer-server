...
import syncer.syncerjedis.Protocol.Keyword;
import syncer.syncerjedis.params.*;
...
import static syncer.syncerjedis.Protocol.Command.*;
import static syncer.syncerjedis.Protocol.Command.EXISTS;
import static syncer.syncerjedis.Protocol.Command.GET;
import static syncer.syncerjedis.Protocol.Command.KEYS;
import static syncer.syncerjedis.Protocol.Command.PING;
import static syncer.syncerjedis.Protocol.Command.PSUBSCRIBE;
import static syncer.syncerjedis.Protocol.Command.PUNSUBSCRIBE;
import static syncer.syncerjedis.Protocol.Command.SET;
import static syncer.syncerjedis.Protocol.Command.SUBSCRIBE;
import static syncer.syncerjedis.Protocol.Command.TIME;
import static syncer.syncerjedis.Protocol.Command.UNSUBSCRIBE;
import static syncer.syncerjedis.Protocol.Keyword.*;
