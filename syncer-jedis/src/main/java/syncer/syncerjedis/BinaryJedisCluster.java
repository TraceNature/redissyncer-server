...
import syncer.syncerjedis.commands.BinaryJedisClusterCommands;
import syncer.syncerjedis.commands.JedisClusterBinaryScriptingCommands;
import syncer.syncerjedis.commands.MultiKeyBinaryJedisClusterCommands;
import syncer.syncerjedis.commands.ProtocolCommand;
import syncer.syncerjedis.params.GeoRadiusParam;
import syncer.syncerjedis.params.SetParams;
import syncer.syncerjedis.params.ZAddParams;
import syncer.syncerjedis.params.ZIncrByParams;
import syncer.syncerjedis.util.JedisClusterHashTagUtil;
import syncer.syncerjedis.util.KeyMergeUtil;
...
public class BinaryJedisCluster implements BinaryJedisClusterCommands,
   ...
   * @param nodesMap
   */
  public BinaryJedisCluster(Set<HostAndPort> nodes, int timeout,Map<String,String>nodesMap) {
   ...
   * @param nodesMap
   */
  public BinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, GenericObjectPoolConfig poolConfig,Map<String,String>nodesMap) {
    this.connectionHandler = new JedisSlotBasedConnectionHandler(jedisClusterNode, poolConfig,
