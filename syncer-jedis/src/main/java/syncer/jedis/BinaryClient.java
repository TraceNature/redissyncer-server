...
import syncer.jedis.Protocol.Keyword;
...
import static syncer.jedis.Protocol.Command.*;
import static syncer.jedis.Protocol.Command.EXISTS;
import static syncer.jedis.Protocol.Command.GET;
import static syncer.jedis.Protocol.Command.KEYS;
import static syncer.jedis.Protocol.Command.PING;
import static syncer.jedis.Protocol.Command.PSUBSCRIBE;
import static syncer.jedis.Protocol.Command.PUNSUBSCRIBE;
import static syncer.jedis.Protocol.Command.SET;
import static syncer.jedis.Protocol.Command.SUBSCRIBE;
import static syncer.jedis.Protocol.Command.TIME;
import static syncer.jedis.Protocol.Command.UNSUBSCRIBE;
import static syncer.jedis.Protocol.Keyword.*;
