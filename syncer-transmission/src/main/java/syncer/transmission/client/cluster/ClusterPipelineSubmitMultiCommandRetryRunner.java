...
import syncer.transmission.client.impl.JedisRetryRunner;
 ...
 */
@Slf4j
public class ClusterPipelineSubmitMultiCommandRetryRunner implements JedisRetryRunner {
    private SingleMultiExecRedisClient client;

    public ClusterPipelineSubmitMultiCommandRetryRunner(SingleMultiExecRedisClient client) {
        this.client = client;
    }
    ...
    public void run()  throws JedisConnectionException {
        ...
        client.targetClient=client.createJedis(client.targetHost,client.targetPort,client.targetPassword);
