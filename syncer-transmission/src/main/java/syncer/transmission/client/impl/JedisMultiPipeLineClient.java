 ...
 */
@Slf4j
public class JedisMultiPipeLineClient implements RedisClient {
    private String host;
    ...
    public JedisMultiPipeLineClient(String host, Integer port, String password, int count, long errorCount, String taskId) {
        ...
        ThreadPoolUtils.exec(new JedisMultiPipeLineClient.PipelineSubmitThread(taskId));
    }
