...
@Getter
@Setter
public class CommandProcessingRdbMultiCommandSendStrategy implements CommonProcessingStrategy {
    ...
    public CommandProcessingRdbMultiCommandSendStrategy(CommonProcessingStrategy next, RedisClient client, String taskId, double redisVersion, Date date, TaskModel taskModel) {
        this.next = next;
        this.client = client;
        this.taskId = taskId;
