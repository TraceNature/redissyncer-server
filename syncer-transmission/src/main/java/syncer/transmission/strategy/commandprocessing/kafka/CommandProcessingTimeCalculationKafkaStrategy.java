...
@Setter
@Slf4j
public class CommandProcessingTimeCalculationKafkaStrategy implements CommonProcessingStrategy {
    private CommonProcessingStrategy next;
    private KafkaProducerClient client;
    private String taskId;
    private TaskModel taskModel;

    public CommandProcessingTimeCalculationKafkaStrategy(CommonProcessingStrategy next, KafkaProducerClient client, String taskId,  TaskModel taskModel) {
        this.next = next;
        this.client = client;
        this.taskId = taskId;
