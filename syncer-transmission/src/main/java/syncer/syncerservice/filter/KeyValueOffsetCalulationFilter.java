...
@Setter
@Slf4j
public class KeyValueOffsetCalulationFilter implements CommonFilter {
    private CommonFilter next;
    private JDRedisClient client;
    private String taskId;
    private Long size;

    public KeyValueOffsetCalulationFilter(CommonFilter next, JDRedisClient client, String taskId, Long size) {
        this.next = next;
        this.client = client;
        this.taskId = taskId;
        this.size = size;
