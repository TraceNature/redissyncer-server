...
public class MultiQueueFilter implements CommonFilter {
    ...
    public MultiQueueFilter(RedisBranchTypeEnum branchTypeEnum, RedisSyncDataDto syncDataDto, String type, Replicator r, String taskId,int batchSize) {
        ...
        for (int i = 0; i < QUEUE_SIZE; i++) {
            ...
            JDRedisClient client = JDRedisClientFactory.createJDRedisClient(branchTypeEnum, syncDataDto.getTargetHost(), syncDataDto.getTargetPort(), syncDataDto.getTargetPassword(), batchSize,syncDataDto.getErrorCount(), taskId,null,null);
