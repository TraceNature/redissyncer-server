...
package com.i1314i.syncerplusredis.event;


import com.i1314i.syncerplusredis.util.type.Tuple2;
...
public abstract class AbstractEvent implements Event {
    ...
    private static class ContextImpl implements Context {
         ...
         * 
         * 1. if event is self-define event like {@link com.i1314i.syncerplusredis.event.PreRdbSyncEvent}
         *    or {@link com.i1314i.syncerplusredis.event.PreCommandSyncEvent}  and etc.
         *    then offset.getV2() - offset.getV1() = 0. 
         *    Notice that {@link com.i1314i.syncerplusredis.event.PostRdbSyncEvent} is not self-define event.
