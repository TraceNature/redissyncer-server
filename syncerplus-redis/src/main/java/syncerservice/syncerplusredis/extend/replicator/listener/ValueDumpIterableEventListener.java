package syncerservice.syncerplusredis.extend.replicator.listener;
...
public class ValueDumpIterableEventListener implements syncerservice.syncerplusredis.event.EventListener {

    private final int batchSize;
    private final boolean order;
    private final syncerservice.syncerplusredis.event.EventListener listener;

    public ValueDumpIterableEventListener(syncerservice.syncerplusredis.event.EventListener listener) {
        this(64, listener);
    }

    public ValueDumpIterableEventListener(int batchSize, syncerservice.syncerplusredis.event.EventListener listener) {
