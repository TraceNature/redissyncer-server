...
import syncerservice.syncerplusredis.cmd.impl.ZRemRangeByRankCommand;
...
public class ZRemRangeByRankParser implements CommandParser<ZRemRangeByRankCommand> {
    ...
    public ZRemRangeByRankCommand parse(Object[] command) {
        ...
        idx++;
        long start = CommandParsers.toLong(command[idx++]);
        long stop = CommandParsers.toLong(command[idx++]);
